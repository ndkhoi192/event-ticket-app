    ...
    return (
        <View className="flex-1 bg-gray-100 pt-12 px-4 pb-8">
            ...
            <View className="bg-white rounded-2xl border border-gray-300 mb-5 overflow-hidden">
                ...
                {renderMenuItem("Change Password", () => router.push("/(attendee)/change-password"))}
            ...
            <View className="bg-white rounded-2xl border border-gray-300 mb-8 overflow-hidden">
                {renderMenuItem("Help Center", () => router.push({ pathname: "/support/[slug]", params: { slug: "help-center", from: "attendee-profile" } }))}
                {renderMenuItem("Terms of Service", () => router.push({ pathname: "/support/[slug]", params: { slug: "terms-of-service", from: "attendee-profile" } }))}
                {renderMenuItem("Privacy Policy", () => router.push({ pathname: "/support/[slug]", params: { slug: "privacy-policy", from: "attendee-profile" } }))}
                {renderMenuItem("About", () => router.push({ pathname: "/support/[slug]", params: { slug: "about", from: "attendee-profile" } }), true)}
            </View>
